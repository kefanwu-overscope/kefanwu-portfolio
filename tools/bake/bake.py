...
# ---- approved P0-A light rig (bright workshop) ----
...
# soft strip glow inside the (real-time) cabinet zone so the wall behind it
# isn't a black hole in the bake — approximates the shelf strips
...
raw_path = os.path.join(OUTDIR, "lightmap_raw.hdr")
...
scene.render.filepath = os.path.join(OUTDIR, "lightmap.hdr")
scene.camera = None
...
scene.render.filepath = os.path.join(OUTDIR, "probe.hdr")
